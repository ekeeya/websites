...
const HowItWorksDirection = (props:DirectionProps)=>{
    ...
    return(
        <div className="flex items-center justify-between z-0 bg-[#222707] rounded-lg w-full basis-full lg:basis-[26%] xl:basis-1/4 flex-shrink-0 space-x-2 transition-all duration-300 ease-in-out">
            ...
            <div className="flex-1 text-white text-left pr-2">
                <div className="text-sm xl:text-xl lg:w-full">{text}</div>
            </div>
        </div>
    )
}
